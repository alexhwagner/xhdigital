...
import globoScreenshot from "@/assets/globo.png";
...
const PortfolioSection = () => {
  const portfolio = [
    ...
    {
      id: 2,
      title: "Globo Celulares",
      description:
        "Cartão de visita digital para loja de celulares, com design moderno e funcionalidade de contato rápido.",
      image: globoScreenshot,
      link: "https://globocelulares.netlify.app/",
