...
const testimonials = [
  {
    name: "Claudio",
    role: "CEO — Barbearia Gabiroba",
    text: "A landing page ficou simplesmente incrível. Moderna, profissional e com a identidade perfeita da minha barbearia. Depois do site, passei muito mais credibilidade e comecei a receber mais clientes. Trabalho impecável!",
    stars: 5,
    metric: "+320% conversões",
  },
  {
    name: "Arni",
    role: "CEO — Globo Celulares",
    text: "A página ficou impecável. Profissional",
    stars: 5,
    metric: "+120% conversões",
  },
  {
    name: "Kiko",
    role: "CEO — Lanchonete do Kiko",
    text: "A landing page da XH Digital fez toda a diferença.",
    stars: 5,
    metric: "108.2x + visitantes",
  },
];
